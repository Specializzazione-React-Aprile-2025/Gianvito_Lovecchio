        ...
        <nav className="bg-gray-800">
                ...
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="hidden sm:ml-6 sm:block">
                            <div className="flex space-x-4">
                                ...
                                <Link to="/">
                                    <p href="#" className="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" aria-current="page">Home</p>
                                </Link>
                                <Link to="/genres">
                                    <p href="#" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Generi</p>
                                </Link>
                                <Link to="/best">
                                    <p href="#" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Best</p>
                                </Link>
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <div className="relative ml-3">
                            ...
                            {/* 👇 DROPDOWN VISIBILE SOLO SE dropdownOpen === true */}
                            {dropdownOpen && (
                                <div
                                    ...
                                    tabIndex="-1"
                                >
                                    <p className="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabIndex="-1">Your Profile</p>
            ...
            <div className="sm:hidden" id="mobile-menu">
                <div className="space-y-1 px-2 pb-3 pt-2">
                    {/* <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" --> */}
                    <Link to="/">
                        <p href="#" className="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" aria-current="page">Home</p>
                    </Link>
                    <Link to="/genres">
                        <p href="#" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Generi</p>
                    </Link>
                    <Link to="/best">
                        <p href="#" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Best</p>
                    </Link>
                </div>
            </div>
        </nav>
